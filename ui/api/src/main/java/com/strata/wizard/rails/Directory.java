...
/**
 * In-memory directory of debit accounts (ours) and saved beneficiaries
 * (counterparties paid before). Direct port of directory.py.
 *
...
public class Directory {
    ...
    public static final List<Map<String, Object>> BENEFICIARIES = List.of(
            ben(1, "Acme GmbH",             "DE", "EUR", "sepa_inst", "2026-06-02", 12, Map.of(
                    "iban", "DE89370400440532013000",
                    "bic",  "COBADEFFXXX")),
            ben(2, "Cloudflare Inc",        "US", "USD", "us_ach",   "2026-05-29",  8, Map.of(
                    "routing_number", "021000021",
                    "account_number", "987654321",
                    "account_type",   "checking")),
            ben(3, "Paris Logistique SARL", "FR", "EUR", "sepa_inst","2026-04-15",  5, Map.of(
                    "iban", "FR1420041010050500013M02606",
                    "bic",  "PSSTFRPPXXX")),
            ben(4, "Smith & Holland LLP",   "GB", "GBP", "uk_fps",   "2026-05-20", 18, Map.of(
                    "sort_code",      "20-30-40",
                    "account_number", "12345678",
                    "reference",      "INV-2026")),
            ben(5, "Mumbai Consulting Pvt Ltd", "IN", "INR", "india_imps", "2026-05-10", 3, Map.of(
                    "india_mode",    "account",
                    "ifsc_code",     "HDFC0001234",
                    "account_number","123456789012")),
            ben(6, "Itau Consultoria",      "BR", "BRL", "brazil_pix","2026-05-25", 4, Map.of(
                    "pix_key", "consultor@itau.com.br")),
            ben(7, "Tokyo Software KK",     "JP", "JPY", "swift_mt103","2026-03-01", 2, Map.of(
                    "bic",                 "BOTKJPJT",
                    "account_number",      "1234567",
                    "beneficiary_address", "1-2-3 Marunouchi, Chiyoda-ku, Tokyo 100-0005, Japan",
                    "charges_code",        "SHA")),
            ben(8, "Singapore Trade Pte",   "SG", "SGD", "swift_mt103","2026-02-20", 1, Map.of(
                    "bic",                 "DBSSSGSG",
    ...
    private static Map<String, Object> ben(int id, String name, String country, String currency,
                                           String rail, String lastPaid, int count, Map<String, Object> fields) {
        return Map.of(
    ...
    public List<Map<String, Object>> findBeneficiaries(String query, String country) {
        return BENEFICIARIES.stream()
                ...
                .filter(b -> query == null || query.isBlank()
                        || ((String) b.get("name")).toLowerCase().contains(query.toLowerCase()))
                .toList();
    }
    ...
    /**
     * Match the user's text against saved-beneficiary names.
     * Multi-token names require all significant tokens to appear to avoid
     * false positives.
     */
